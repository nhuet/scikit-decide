...
class ParametersGPHH(Hyperparametrizable):
    ...
    hyperparameters = [
        FloatHyperparameter(name="tournament_ratio", default=0.1),
        IntegerHyperparameter(name="pop_size", default=40),
        IntegerHyperparameter(name="n_gen", default=100),
        IntegerHyperparameter(name="min_tree_depth", default=1),
        IntegerHyperparameter(name="max_tree_depth", default=4),
        FloatHyperparameter(name="crossover_rate", default=0.7),
        FloatHyperparameter(name="mutation_rate", default=0.3),
        EnumHyperparameter(
            name="evaluation", enum=EvaluationGPHH, default=EvaluationGPHH.SGS
        ),
        EnumHyperparameter(
            name="permutation_distance",
            enum=PermutationDistance,
            default=PermutationDistance.KTD,
        ),
