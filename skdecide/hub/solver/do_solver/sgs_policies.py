...
class PolicyMethodParams(Hyperparametrizable):
    ...
    hyperparameters = [
        EnumHyperparameter(name="base_policy_method", enum=BasePolicyMethod),
        IntegerHyperparameter(name="delta_time_freedom", default=10),
        IntegerHyperparameter(name="delta_index_freedom", default=10),
    ]
