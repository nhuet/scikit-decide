...
class MaxentIRL(Solver, Policies):
    ...
    hyperparameters = [
        IntegerHyperparameter(name="n_states", default=400),
        IntegerHyperparameter(name="n_actions", default=3),
        IntegerHyperparameter(name="one_feature", default=20),
        FloatHyperparameter(name="gamma", default=0.99),
        FloatHyperparameter(name="q_learning_rate", default=0.03),
        FloatHyperparameter(name="theta_learning_rate", default=0.05),
        IntegerHyperparameter(name="n_epochs", default=20000),
    ]
