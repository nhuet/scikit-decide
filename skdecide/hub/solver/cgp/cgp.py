...
class CGPWrapper(Solver, DeterministicPolicies):
    ...
    hyperparameters = [
        IntegerHyperparameter(name="col", default=100),
        IntegerHyperparameter(name="row", default=1),
        IntegerHyperparameter(name="nb_ind", default=4),
        FloatHyperparameter(name="mutation_rate_nodes", default=0.1),
        FloatHyperparameter(name="mutation_rate_outputs", default=0.3),
        IntegerHyperparameter(name="n_it", default=1000000),
    ]
